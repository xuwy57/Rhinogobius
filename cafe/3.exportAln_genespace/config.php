...
define("TRANSLATORX_PATH","/data/software/TranslatorX/translatorx_vLocal.pl");
...
define("RAXML_PATH","/data/software/standard-RAxML-8.2.12/raxmlHPC-PTHREADS-AVX2");
define("CONSEL_PATH","/data/software/consel/src");
define("HYPHY_PATH","/data/software/hyphy-2.5.32/build/");
